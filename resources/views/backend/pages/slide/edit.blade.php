                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="row g-3 needs-validation" method="post"
                                action="{{ route('slide.update', $item['id']) }}" novalidate
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="subtitle" value="{{$item['subtitle']}}" class="form-control" id="validationCustom01"
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select name="btn_status" class="form-control">
                                            <option value="active"
                                                {{ $item['btn_status'] == 'active' ? 'selected' : '' }}>
                                                Activé
                                            </option>
                                            <option value="desactive"
                                                {{ $item['btn_status'] == 'desactive' ? 'selected' : '' }}>Desactivé
                                            </option>
                                        </select>
                                        <div class="valid-feedback">
                                            Looks good!
