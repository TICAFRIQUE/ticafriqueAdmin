                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="row g-3 needs-validation" method="post"
                                action="{{ route('media-content.update', $item['id']) }}" novalidate
                                    ...
                                    <select name="categorie" class="form-control" required>
                                        ...
                                        @foreach ($data_media_category as $category)
                                            <option value="{{ $category['id'] }}"
                                                {{ $item['media_categories_id'] == $category['id'] ? 'selected' : '' }}>
                                                {{ $category['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-12">
                                   ...
                                   <div class="col-md-12">
                                    ...
                                    <input type="text" name="url" value="{{$item['url']}}" class="form-control" id="validationCustom01"
                                        >
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="status" class="form-control">
                                        ...
                                        <option value="desactive"
                                            {{ $item['status'] == 'desactive' ? 'selected' : '' }}>
                                            Desactivé
                                        </option>
                                    </select>
                                    <div class="valid-feedback">
