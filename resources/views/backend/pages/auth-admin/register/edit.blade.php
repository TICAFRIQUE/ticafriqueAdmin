                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{$item['last_name']}}" name="last_name" class="form-control" id="username" required>
                                </div>

                                <div class="mb-3">
                                    <label for="username" class="form-label">Prenoms</label>
                                    <input type="text" value="{{$item['first_name']}}" name="first_name" class="form-control" id="username"
                                        required>
                                </div>

                                <div class="mb-3">
                                    <label for="username" class="form-label">Email</label>
                                    <input type="email" value="{{$item['email']}}" name="email" class="form-control" id="username" required>
                                </div>

                                <div class="mb-3">
                                    <label for="username" class="form-label">Telephone</label>
                                    <input type="number" value="{{$item['phone']}}" name="phone" class="form-control" id="username" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="role" id="" required>
                                        ...
                                        @foreach ($data_role as $role)
                                            <option value="{{ $role['name'] }}" {{$role['id'] == $item['roles'][0]['id'] ? 'selected' : ''}}>{{ $role['name'] }} </option>
                                        @endforeach
                                    </select>
                                </div>
