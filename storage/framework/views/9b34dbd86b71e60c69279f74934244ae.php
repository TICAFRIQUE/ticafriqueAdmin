                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="row g-3 needs-validation" method="post" action="<?php echo e(route('blog-category.position' , $item['id'])); ?>"
                                novalidate>
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="position" class="form-control">
                                     <?php for($i = 1; $i <= count($data_blog_category); $i++): ?>
...
<?php /**PATH C:\laragon\www\admin\ticafriqueAdmin\resources\views/backend/pages/blog/category/position.blade.php ENDPATH**/ ?>