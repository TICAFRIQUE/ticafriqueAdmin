...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form class="row g-3 needs-validation" method="post" action="<?php echo e(route('service.store')); ?>" novalidate
                        ...
                        <div class="col-md-12">
                            <label for="validationCustom01" class="form-label">Description du service</label>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\admin\ticafriqueAdmin\resources\views/backend/pages/service/create.blade.php ENDPATH**/ ?>