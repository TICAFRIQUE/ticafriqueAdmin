                            ...
                            <form class="row g-3 needs-validation" method="post"
                                ...
                                <div class="col-md-12">
                                   ...
                                   <div class="col-md-12">
                                    ...
                                    <input type="text" name="url" value="<?php echo e($item['url']); ?>" class="form-control" id="validationCustom01"
                                        >
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
...
<?php /**PATH C:\laragon\www\admin\ticafriqueAdmin\resources\views/backend/pages/media/content/edit.blade.php ENDPATH**/ ?>